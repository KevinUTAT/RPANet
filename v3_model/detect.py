...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='video/20200601_105508.mp4', \
        help='source supports files path or rstp, http or .txt stream, pass in Screen for screen cap')  # input file/folder, 0 for webcam
